---
title: 'Content Moderation API for Developers'
description: 'A developer tool for moderating content saftey.'
image: '/project/appwrite.png'
technologies:
  ['Javascript', 'React', 'Nodejs', 'Vercel', 'Zod', 'GCP']
github: 'https://github.com/sushil016/mod-x'
live: 'https://https://mod-x-409486837822.asia-south1.run.app/'
timeline: '5 Hours'
role: 'Full Stack'
team: 'Solo'
status: 'Completed'
